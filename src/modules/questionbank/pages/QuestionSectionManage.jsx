...
import formDef from "../../../forms/details-forms/question-section-details.json";
import masterConfig from "../../../forms/master-forms/question-section-master.json";
import DetailsForm from "../../../forms/components/DetailsForm";
import MasterForm from "../../../forms/components/MasterForm";

const QuestionSectionManage = () => {
    const { id } = useParams();
...
export default QuestionSectionManage;
